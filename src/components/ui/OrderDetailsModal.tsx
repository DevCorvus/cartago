  ...
  return (
    <Portal id="modal-container">
      <div className="z-50 absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50">
        <div
          ref={ref}
          className="bg-white shadow-md rounded-lg p-10 border-2 border-gray-50 flex flex-col gap-6"
        >
                  ...
                  <div className="text-sm flex items-center justify-between">
                    <p>
                      ...
                      <span className="text-green-800 px-1 py-0.5 bg-green-100 rounded-md">
                        {Dinero({ amount: item.price }).toFormat()}
                      </span>
                    </p>
                    <p>
          ...
          <p className="text-lg">
            <span>Total</span>{' '}
            <strong className="text-green-800 px-2 py-1 bg-green-100 rounded-lg">
              {Dinero({ amount: order.total }).toFormat()}
            </strong>
          </p>
          <hr />
