...
export default function ChangePasswordForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-md lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2">
      <form
        ref={ref}
        onSubmit={handleSubmit(onSubmit)}
        className="max-w-sm space-y-8 rounded-lg border-2 border-slate-100 bg-white p-6 shadow-md"
      >
        <header>
